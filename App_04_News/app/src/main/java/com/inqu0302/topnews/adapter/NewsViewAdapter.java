package com.inqu0302.topnews.adapter;
...
import com.inqu0302.topnews.databinding.NewsItemViewBinding;
 ...
 * RecyclerView.ViewHolder클래스를 상속받은
 * inner class를 포함한다
 */
public class NewsViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static class NewsViewHolder extends RecyclerView.ViewHolder{
        /**
         * binding 속성을 사용하면
         * item_view.xml에 설정된 view component를 알아서 찾아준다
         * item_view.xml파일에 의해 생성된 ItemViewBinding클래스를 사용하여
